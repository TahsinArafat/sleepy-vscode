<p align="center">
  <strong>Sleepy Code</strong> — AI coding agent for VS Code, powered by your Sleepy Code platform.
</p>

<p align="center">
  OAuth login to your Sleepy Code gateway &bull; Model routing via OmniRoute &bull; Virtual key management
</p>
...
## Sleepy Code Integration

Sleepy Code is a fork of Kilo Code that authenticates against your own Sleepy Code platform instance:

- **OAuth Login** — Sign in with your Sleepy Code account via `Sleepy Code: Sign In` in VS Code
...
1. Install the Sleepy Code extension from the VSIX file or VS Code Marketplace.
2. Press `Cmd+Shift+P` and run `Sleepy Code: Sign In`.
3. Your browser opens to the Sleepy Code OAuth consent page — approve the request.
...
| Command | Description |
|---------|-------------|
| `Sleepy Code: Sign In` | Start OAuth login flow |
| `Sleepy Code: Sign Out` | Clear stored credentials |
| `Sleepy Code: Open` | Open the Sleepy Code chat panel |
